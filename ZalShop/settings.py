...
# to load .env file to connect to postgres
load_dotenv()
...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-u6ds#@79v#&7*)yex@!w!m3k7k)c63#1g7&58cn0-_$h7g%quo")
...
WSGI_APPLICATION = 'ZalShop.wsgi.application'
